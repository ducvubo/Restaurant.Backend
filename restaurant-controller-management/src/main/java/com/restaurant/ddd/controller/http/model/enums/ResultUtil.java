package com.restaurant.ddd.controller.http.model.enums;
...
public class ResultUtil<T> {
    ...
    /**
     * Phương thức tĩnh trừu tượng, trả về tập kết quả với message tùy chỉnh
     *
     * @param t       Kiểu dữ liệu
     ...
     * @return Thông báo
     */
    public static <T> ResultMessage<T> data(T t, String message) {
        ResultMessage<T> result = new ResultUtil<T>().setData(t);
        result.setMessage(message);
        return result;
    }

    /**
     * Phương thức tĩnh trừu tượng, trả về tập kết quả với ResultCode
     *
     * @param t         Kiểu dữ liệu
     ...
     * @return Thông báo
     */
    public static <T> ResultMessage<T> data(T t, ResultCode resultCode) {
        ResultMessage<T> result = new ResultUtil<T>().setData(t);
